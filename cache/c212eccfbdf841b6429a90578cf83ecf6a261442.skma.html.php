<?php /*%%SmartyHeaderCode:1128453645f970e95274e26-68736894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c212eccfbdf841b6429a90578cf83ecf6a261442' => 
    array (
      0 => '/www/wwwroot/paofen123.com/admin/view/Pay/skma.html',
      1 => 1581840097,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1128453645f970e95274e26-68736894',
  'variables' => 
  array (
    'updateall' => 0,
    'mtype_arr' => 0,
  ...
  'unifunc' => 'content_5f970e9530aaa8_76820689',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f970e9530aaa8_76820689')) {function content_5f970e9530aaa8_76820689($_smarty_tpl) {?><style>
...
<script type="text/html" id="layerTpl">
    <form class="layui-form LayerForm" onsubmit="return false;">
        ...
        <div class="layui-form-item layui-form-text maxBox" style="display:none;">
            ...
            <div class="layui-input-block">
                <input type="text" id="min_money" placeholder="" style="width:50%;" autocomplete="off" class="layui-input" value="{{d.item.min_money||0}}" />
            </div>
        </div>
        <div class="layui-form-item layui-form-text maxBox" style="display:none;">
            <label class="layui-form-label"><span>单笔最大</span>：</label>
            <div class="layui-input-block">
                <input type="text" id="max_money" placeholder="" style="width:50%;" autocomplete="off" class="layui-input" value="{{d.item.max_money||20000}}"  />
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                                <input type="radio" name="status" value="1" title="离线" checked="checked" />
...
<script type="text/html" id="layerTpl2">
    <form class="layui-form LayerForm" onsubmit="return false;">
        ...
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label"><span>单笔最小</span>：</label>
            <div class="layui-input-block">
                <input type="text" id="ms_min_money" placeholder="" style="width:50%;" autocomplete="off" class="layui-input" value="0" />
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label"><span>单笔最大</span>：</label>
            <div class="layui-input-block">
                <input type="text" id="ms_max_money" placeholder="" style="width:50%;" autocomplete="off" class="layui-input" value="20000" />
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
