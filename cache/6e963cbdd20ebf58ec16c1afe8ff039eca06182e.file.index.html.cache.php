<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-10-27 00:24:26
         compiled from "/www/wwwroot/paofen123.com/admin/view/Login/index.html" */ ?>
<?php /*%%SmartyHeaderCode:5076383925f96f83a37d4d2-82938791%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e963cbdd20ebf58ec16c1afe8ff039eca06182e' => 
    array (
      0 => '/www/wwwroot/paofen123.com/admin/view/Login/index.html',
      1 => 1578476498,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5076383925f96f83a37d4d2-82938791',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f96f83a3d7ca4_79229657',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f96f83a3d7ca4_79229657')) {function content_5f96f83a3d7ca4_79229657($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title>后台登录</title>
  ...
  <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
		...
		<?php if ($_smarty_tpl->tpl_vars['s']->value['f']&&false) {?>
        <div class="layui-form-item">
          <div class="layui-row">
        ...
        <div class="layui-form-item">
          <div class="layui-row">
            ...
            <div class="layui-col-xs5">
              <div style="margin-left: 10px;">
                <img src="<?php echo @constant('APP_URL');?>
?c=Login&a=varify_code" class="layadmin-user-login-codeimg" id="LAY-user-get-vercode">
              </div>
            </div>
          </div>
        </div>
...
$('#LAY-user-login-submit').on('click',function(){
  ...
  ajax({
    ...
    data:{acname:acname,pwd:pwd,code:code,save_state:save_state,seccd:seccd,gcode:gcode,smscode:smscode,f:'<?php echo $_smarty_tpl->tpl_vars['s']->value['f'];?>
'},
    success:function(json){
      if(json.code!='1'){
        _alert(json.msg);
      ...
      _alert(json.msg,{icon:1},function(){
		...
		location.href='<?php echo $_smarty_tpl->tpl_vars['callback']->value;?>
';
      });
