...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5f964a214e67e7_60762798',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f964a214e67e7_60762798')) {function content_5f964a214e67e7_60762798($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>提现</title>
...
<div class="cashOut">
	...
	<div class="cashOutCon">
		<p class="txtline">账号：***</p>
				<p class="txtline">可提余额：￥10000 <a href="javascript:;" class="editBtn transToBalance" style="width:6rem;" data-type="1">可提⇄接单</a></p>
		<p class="txtline">接单余额：￥2975.26 <a href="javascript:;" class="editBtn transToBalance" style="width:6rem;" data-type="2">接单⇄可提</a></p>
		<p class="txtline">接单冻结：￥0.23</p>
...
$(function(){
	...
	$('.transToBalance').on('click',function(){
		...
		if(ptype==1){
			...
			$('.balanceFlag').text('10000');
		}else if(ptype==2){
			title='接单余额->可提现余额';
			$('.balanceTit').text('接单余额：');
			$('.balanceFlag').text('2975.26');
		}else{
			_alert('未知操作类型');
			return;
		}
