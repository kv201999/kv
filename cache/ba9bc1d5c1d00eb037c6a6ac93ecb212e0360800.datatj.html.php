<?php /*%%SmartyHeaderCode:302165f969d3eb4ab40-16278390%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ba9bc1d5c1d00eb037c6a6ac93ecb212e0360800' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\admin\\view\\User\\datatj.html',
      1 => 1578476498,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '302165f969d3eb4ab40-16278390',
  'variables' => 
  array (
    's' => 0,
    'mtype_arr' => 0,
  ...
  'unifunc' => 'content_5f969d3ebaee42_11846115',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f969d3ebaee42_11846115')) {function content_5f969d3ebaee42_11846115($_smarty_tpl) {?><div class="layui-card">
		...
		<div class="layui-form-item" style="margin-bottom:5px;">
			<div class="layui-inline" style="margin-right:0;">
				...
				<div class="layui-input-inline" style="width:120px;">
					<input name="s_start_time" id="s_start_time" value="2020-10-19" class="layui-input" placeholder="开始日期" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="width:30px;">结束</label>
				<div class="layui-input-inline" style="width:120px;">
					<input name="s_end_time" id="s_end_time" value="2020-10-26" class="layui-input" placeholder="结束日期">
				</div>
			</div>
			<div class="layui-inline">
