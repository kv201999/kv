<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-10-27 01:29:06
         compiled from "/www/wwwroot/paofen123.com/admin/view/User/userms.html" */ ?>
<?php /*%%SmartyHeaderCode:12974638515f97076206bd10-13121638%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca818556ad23f56f3d5ee66fd1b981359ecacce0' => 
    array (
      0 => '/www/wwwroot/paofen123.com/admin/view/User/userms.html',
      1 => 1578880071,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12974638515f97076206bd10-13121638',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9707621116c2_24227576',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9707621116c2_24227576')) {function content_5f9707621116c2_24227576($_smarty_tpl) {?><div class="layui-col-md12">
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value;?>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" id="paccount" placeholder="邀请人账号不填则忽略" autocomplete="off" class="layui-input" <?php if ($_smarty_tpl->tpl_vars['user']->value['gid']>41) {?>disabled value="{{d.item.paccount||'<?php echo $_smarty_tpl->tpl_vars['user']->value['account'];?>
'}}"<?php } else { ?>value="{{d.item.paccount||''}}"<?php }?> />
			</div>
		</div>
		<div class="layui-form-item">
...
$_smarty_tpl->tpl_vars['vo']->_loop = true;
 $_smarty_tpl->tpl_vars['skey']->value = $_smarty_tpl->tpl_vars['vo']->key;
?>
				<input type="radio" name="is_online" value="<?php echo $_smarty_tpl->tpl_vars['skey']->value;?>
" title="<?php echo $_smarty_tpl->tpl_vars['vo']->value;?>
" <?php if (!$_smarty_tpl->tpl_vars['skey']->value) {?>checked<?php }?>>
				<?php } ?>
			</div>
		</div>
...
$_smarty_tpl->tpl_vars['vo']->_loop = true;
 $_smarty_tpl->tpl_vars['skey']->value = $_smarty_tpl->tpl_vars['vo']->key;
?>
				<input type="radio" name="is_google" value="<?php echo $_smarty_tpl->tpl_vars['skey']->value;?>
" title="<?php echo $_smarty_tpl->tpl_vars['vo']->value;?>
" <?php if (!$_smarty_tpl->tpl_vars['skey']->value) {?>checked<?php }?>>
				<?php } ?>
		...
		<div class="layui-form-item forbidItem" style="display:none;">
			...
			<div class="layui-input-block" style="width:120px;">
				<select id="forbid_time_flag">
					<?php  $_smarty_tpl->tpl_vars['vo'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vo']->_loop = false;
 $_smarty_tpl->tpl_vars['skey'] = new Smarty_Variable;
 $_from = getConfig('cnf_forbid_time'); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['vo']->key => $_smarty_tpl->tpl_vars['vo']->value) {
$_smarty_tpl->tpl_vars['vo']->_loop = true;
 $_smarty_tpl->tpl_vars['skey']->value = $_smarty_tpl->tpl_vars['vo']->key;
?>
	...
	<form class="layui-form LayerForm" onsubmit="return false;">
		...
		<div class="layui-form-item" style="margin-bottom:0;">
			...
			<div class="layui-input-block">
				...
				<?php } else { ?>
				<input type="radio" name="ptype" value="3" title="接单余额" checked="checked">
				<?php }?>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<?php } else { ?>
				<span style="color:#f60;">我的接单余额：<span class="upSxBalance">0</span></span>
				<?php }?>
			</div>
		</div>
		<div class="layui-form-item">
...
var up_sx_balance='<?php echo $_smarty_tpl->tpl_vars['user']->value['sx_balance'];?>
'*1;
