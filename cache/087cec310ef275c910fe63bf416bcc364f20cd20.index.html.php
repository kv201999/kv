<?php /*%%SmartyHeaderCode:2765f993b435f24c9-35594271%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2765f993b435f24c9-35594271',
  'variables' => 
  array (
    'is_msdbhk' => 0,
    'skey' => 0,
  ...
  'unifunc' => 'content_5f993b43934e01_38196755',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f993b43934e01_38196755')) {function content_5f993b43934e01_38196755($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>订单管理</title>
			...
			<div class="ConIn">		
				...
				<div class="Row">
					<div class="inputbox" style="width:94%;margin-left:3%;padding:5px;padding-bottom:10px;">
						<div>银行：中国工商银行</div>
												<div style="margin-bottom:5px;">姓名：钉钉 <span class="cpBtn" data-clipboard-text="钉钉">复制</span></div>
						<div>卡号：TM8t3xwZr1pH9VnCDDX3ESzcuvhgKzEGry <span class="cpBtn" data-clipboard-text="TM8t3xwZr1pH9VnCDDX3ESzcuvhgKzEGry">复制</span></div>
					</div>
				</div>
				<div class="Row">
...
$(function(){
	...
	$('body').on('click','.payHkBtn',function(){
		var bank_account='TM8t3xwZr1pH9VnCDDX3ESzcuvhgKzEGry';
		if(!bank_account){
