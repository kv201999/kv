...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5f9792670acb73_67278175',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9792670acb73_67278175')) {function content_5f9792670acb73_67278175($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>抢单</title>
...
<div class="robOrder">
	<div class="robOrderBox">
		<!-- 立即抢单 -->
		<a href="javascript:;" class="robNowBtn" style="display:none;">立即抢单</a>
		<!-- 停止抢单 -->
	...
	<p class="robOrderTipstxt">每隔200分钟会自动下线</p>
		...
		<p class="userbox"><span>接单余额：1975.49</span><span class="edu">接单冻结：0</span></p>
		<ul>
			<li><p>34</p><p>总单数</p></li>
			<li><p>13</p><p>完成单数</p></li>
			<li><p>38.24%</p><p>成功率</p></li>
			<li><p>14103.64</p><p>总金额 </p></li>
			<li><p>9024.51</p><p>完成金额</p></li>
