...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5f96f83a3e2c86_53761818',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f96f83a3e2c86_53761818')) {function content_5f96f83a3e2c86_53761818($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title>后台登录</title>
  ...
  ajax({
    ...
    success:function(json){
      ...
      _alert(json.msg,{icon:1},function(){
		...
		location.href='http://paofen123.com/ht.php';
      });
