<?php /*%%SmartyHeaderCode:10155f978bc802a0a9-11694523%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff67bbb4a8339eec4055d87b3b89435a086deee5' => 
    array (
      0 => 'D:\\phpstudy_pro\\WWW\\home\\view\\Pay\\info.html',
      1 => 1579222912,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10155f978bc802a0a9-11694523',
  'variables' => 
  array (
    'info' => 0,
  ),
  ...
  'unifunc' => 'content_5f978bc83b6bf7_54319142',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f978bc83b6bf7_54319142')) {function content_5f978bc83b6bf7_54319142($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>PU支付</title>
...
<div class="Payment">
	...
	<div class="PaymentCon">	
		<div class="amount cpBtn" data-clipboard-text="2000.00">￥2000.00<span class="copyBtn">复制</span></div>
				<div class="qrcode" style="width:80%;"><img src="uploads/qr/20201027/ad247c4c340ebdce.jpg" style="width:210px;"></div>
				<div class="uname" style="text-align:left;">
											<p style="text-align:center;">姓名：纷纷</p>
									</div>
		<div class="time">
						<!--倒计时-->
			...
			<div class="zfbBox" style="padding-top:25px;">
				<a class="linkBtn" data-clipboard-text="2000.00" style="background:#0aaaf0;color:#fff;font-size:14px;padding:10px 22px;border-radius:5px;" href="javascript:;">复制金额并打开支付宝</a>
...
$(function(){
    ...
    clipboard2.on('success', function (e) {
		var url='/?c=Pay&a=zfbh5&osn=MS2020102710535673623';
        _alert({
...
$(function(){
	...
	nowOrderSn='MS2020102710535673623';
