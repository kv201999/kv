...
class UploadFile {
    ...
    private $config =   array(
        ...
        'allowExts'         =>  array('jpg', 'gif', 'png', 'jpeg','mp3','wav','csv'),    // 允许上传的文件后缀 留空不作后缀检查
        'allowTypes'        =>  array('image/jpg', 'image/gif', 'image/png', 'image/jpeg','image/jpeg','audio/mp3','audio/x-wav','application/vnd.ms-excel','text/csv'),    // 允许上传的文件类型 留空不做检查
